...
function SIMA_instructRoutineBegin(snapshot) {
  return async function () {
    ...
    SIMA_instructComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function SIMARoutineBegin(snapshot) {
  return async function () {
    ...
    SIMAComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function GADRoutineBegin(snapshot) {
  return async function () {
    ...
    GADComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function pract_instructRoutineBegin(snapshot) {
  return async function () {
    ...
    pract_instructComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function pract_confidenceRoutineBegin(snapshot) {
  return async function () {
    ...
    pract_confidenceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function practice_readyRoutineBegin(snapshot) {
  return async function () {
    ...
    practice_readyComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function get_ready2RoutineBegin(snapshot) {
  return async function () {
    ...
    get_ready2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function practice_startRoutineBegin(snapshot) {
  return async function () {
    ...
    practice_startComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function practice_highlightRoutineBegin(snapshot) {
    return async function () {
      ...
      practice_highlightComponents.forEach( function(thisComponent) {
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
         });
      return Scheduler.Event.NEXT;
...
function conf_practRoutineBegin(snapshot) {
    return async function () {
      ...
      conf_practComponents.forEach( function(thisComponent) {
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
         });
      return Scheduler.Event.NEXT;
...
function easy_baselineRoutineBegin(snapshot) {
    return async function () {
      ...
      easy_baselineComponents.forEach( function(thisComponent) {
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
         });
      return Scheduler.Event.NEXT;
...
function medium_baselineRoutineBegin(snapshot) {
    return async function () {
      ...
      medium_baselineComponents.forEach( function(thisComponent) {
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
         });
      return Scheduler.Event.NEXT;
...
function hard_baselineRoutineBegin(snapshot) {
    return async function () {
      ...
      hard_baselineComponents.forEach( function(thisComponent) {
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
         });
      return Scheduler.Event.NEXT;
...
function ratings_instructions2RoutineBegin(snapshot) {
    return async function () {
      ...
      ratings_instructions2Components.forEach( function(thisComponent) {
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
         });
      return Scheduler.Event.NEXT;
...
function baseline_anticipationRoutineBegin(snapshot) {
    return async function () {
      ...
      baseline_anticipationComponents.forEach( function(thisComponent) {
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
         });
      return Scheduler.Event.NEXT;
...
function baseline_anxietyRoutineBegin(snapshot) {
    return async function () {
      ...
      baseline_anxietyComponents.forEach( function(thisComponent) {
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
         });
      return Scheduler.Event.NEXT;
...
function baseline_feedbackRoutineBegin(snapshot) {
    return async function () {
      ...
      baseline_feedbackComponents.forEach( function(thisComponent) {
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
         });
      return Scheduler.Event.NEXT;
...
function baseline_motivationRoutineBegin(snapshot) {
    return async function () {
      ...
      baseline_motivationComponents.forEach( function(thisComponent) {
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
         });
      return Scheduler.Event.NEXT;
...
function final_instructRoutineBegin(snapshot) {
    return async function () {
      ...
      final_instructComponents.forEach( function(thisComponent) {
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
         });
      return Scheduler.Event.NEXT;
...
function new_code1RoutineBegin(snapshot) {
    return async function () {
      ...
      new_code1Components.forEach( function(thisComponent) {
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
         });
      return Scheduler.Event.NEXT;
...
function error_msg1RoutineBegin(snapshot) {
      return async function () {
        ...
        error_msg1Components.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function highlightRoutineBegin(snapshot) {
      return async function () {
        ...
        highlightComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function attn_check_setup2RoutineBegin(snapshot) {
      return async function () {
        ...
        attn_check_setup2Components.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function attn_check2RoutineBegin(snapshot) {
      return async function () {
        ...
        attn_check2Components.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function confidence_judgementRoutineBegin(snapshot) {
      return async function () {
        ...
        confidence_judgementComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function penalty_boxRoutineBegin(snapshot) {
      return async function () {
        ...
        penalty_boxComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function intertrial1RoutineBegin(snapshot) {
      return async function () {
        ...
        intertrial1Components.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function pause_reflectRoutineBegin(snapshot) {
      return async function () {
        ...
        pause_reflectComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function accuracy_ratingRoutineBegin(snapshot) {
      return async function () {
        ...
        accuracy_ratingComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function guess_amountRoutineBegin(snapshot) {
      return async function () {
        ...
        guess_amountComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function anxiety_ratingRoutineBegin(snapshot) {
      return async function () {
        ...
        anxiety_ratingComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function motivation_ratingRoutineBegin(snapshot) {
      return async function () {
        ...
        motivation_ratingComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function new_code2RoutineBegin(snapshot) {
      return async function () {
        ...
        new_code2Components.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function error_msg2RoutineBegin(snapshot) {
      return async function () {
        ...
        error_msg2Components.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function new_code3RoutineBegin(snapshot) {
      return async function () {
        ...
        new_code3Components.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function error_msg3RoutineBegin(snapshot) {
      return async function () {
        ...
        error_msg3Components.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function attn_check_setupRoutineBegin(snapshot) {
      return async function () {
        ...
        attn_check_setupComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function attn_checkRoutineBegin(snapshot) {
      return async function () {
        ...
        attn_checkComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function attn_check_restartRoutineBegin(snapshot) {
      return async function () {
        ...
        attn_check_restartComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function new_code4RoutineBegin(snapshot) {
      return async function () {
        ...
        new_code4Components.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function error_msg4RoutineBegin(snapshot) {
      return async function () {
        ...
        error_msg4Components.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function final_ratingsRoutineBegin(snapshot) {
      return async function () {
        ...
        final_ratingsComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function easy_postRoutineBegin(snapshot) {
      return async function () {
        ...
        easy_postComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function medium_postRoutineBegin(snapshot) {
      return async function () {
        ...
        medium_postComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function hard_postRoutineBegin(snapshot) {
      return async function () {
        ...
        hard_postComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function relief_postRoutineBegin(snapshot) {
      return async function () {
        ...
        relief_postComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function anxiety_postRoutineBegin(snapshot) {
      return async function () {
        ...
        anxiety_postComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function motivation_postRoutineBegin(snapshot) {
      return async function () {
        ...
        motivation_postComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function post_feedbackRoutineBegin(snapshot) {
      return async function () {
        ...
        post_feedbackComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function feedback_enjoyRoutineBegin(snapshot) {
      return async function () {
        ...
        feedback_enjoyComponents.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
